      ...
      <div className='flex flex-col gap-8 md:flex-row md:justify-between'>
        {personalInfo.profilePicture && (
          <Image
            ...
            width={160}
            height={160}
            className='md:hidden sm:block object-cover aspect-square rounded-lg'
          ></Image>
        )}
        <div className='flex flex-col gap-3'>
          <h1 className='text-4xl font-semibold'>{personalInfo.name}</h1>
          <div className='flex justify-center gap-3 text-neutral-600 hover:text-neutral-900'>
        ...
        {personalInfo.profilePicture && (
          <Image
            ...
            width={160}
            height={160}
            className='hidden md:block object-cover aspect-square rounded-lg transition-all duration-300 hover:shadow-xl hover:shadow-gray-300 dark:shadow-gray-500'
          ></Image>
        )}
      </div>
      <article className='flex flex-col gap-2 text-pretty text-justify'>
        <AboutMd />
      </article>
    </section>
  );
